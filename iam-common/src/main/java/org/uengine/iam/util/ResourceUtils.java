...
public class ResourceUtils {
    ...
    /**
     * 지정한 리소스에 대한 {@link Resource}를 반환한다.
     *
    ...
    /**
     * 지정한 리소스에 대한 {@link Resource}의 내용을 문자열로 반환한다.
     *
     * @param location 리소스 위치
     * @return {@link Resource}의 문자열 내용
    ...
    /**
     * 지정한 리소스에 대한 {@link Resource}의 내용을 바이트 배열로 반환한다.
     *
     * @param location 리소스 위치
     * @return {@link Resource}의 바이트 배열 내용
     * @throws IOException 리소스를 로딩할 수 없는 경우
     */
     ...
     *
     * @param resource 리소스
     * @return {@link Resource}의 문자열 배열 내용
     * @throws IOException 리소스를 로딩할 수 없는 경우
     */
